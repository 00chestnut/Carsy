...
const Login = memo(function Login() {
  ...
  return (
    <Box
      component="main"
      role="main"
      aria-label={t("StronaLogowania", "Strona logowania")}
      sx={{
        minHeight: "100vh",
        width: "100vw",
      ...
      >
        <Box>
              ...
              >
                ...
                >
                  <Box
                    ...
                    alt={t(
                      "CarsyLogoAlt",
                      "Carsy - logo systemu zarządzania warsztatem",
                    )}
                    loading="eager"
                    decoding="async"
                    sx={{
          ...
          >
            ...
            >
              {t(
                "SerwisAutaKtorySzanujeTwojCzas",
        ...
        <Box
          component="section"
          aria-label={t("OpcjeLogowania", "Opcje logowania")}
          sx={{
            bgcolor: "background.paper",
            boxShadow: theme.shadows[4],
        ...
        >
          <Button
            ...
            fullWidth
            type="button"
            aria-label={t("zalogujSie", "Zaloguj się do swojego konta")}
            sx={{
              borderRadius: 999,
              py: 1.3,
              fontWeight: 600,
          ...
          <Button
            ...
            fullWidth
            type="button"
            aria-label={t("zalozKonto", "Załóż nowe konto w systemie Carsy")}
            sx={{
              borderRadius: 999,
              py: 1.3,
              fontWeight: 600,
        ...
        <Box
          component="nav"
          aria-label={t("linkiPomocnicze", "Linki pomocnicze")}
          sx={{
            display: "flex",
            flexDirection: "column",
            gap: 1.25,
        ...
        >
          ...
          >
            {t("niePamietamHasla", "Nie pamiętam hasła")}
          </Link>
          <Link
            component="button"
            type="button"
          ...
          >
            {t("problemZAplikacja", "Problem z aplikacją?")}
          </Link>
          <Link
            component="button"
            type="button"
